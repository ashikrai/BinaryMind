...
import { MediumImportsTab } from "@/features/medium/MediumImportsTab";

type Tab = "published" | "draft" | "collabs" | "medium-imports";

const TABS: { id: Tab; label: string }[] = [
  { id: "published", label: "Published" },
  { id: "draft", label: "Drafts" },
  { id: "collabs", label: "Collaborations" },
  { id: "medium-imports", label: "Medium Imports" },
];
...
export default function MyStories() {
  ...
  const blogs = useMemo<Blog[]>(() => {
    ...
    if (activeTab === "medium-imports") return []; // handled by MediumImportsTab
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      {/* Medium Imports tab — delegated to its own component */}
      {activeTab === "medium-imports" ? (
        <MediumImportsTab />
      ) : (
        <>
          {/* List */}
